...
import com.channelengine.channel.apiclient.auth.Authentication;
import com.channelengine.channel.apiclient.auth.HttpBasicAuth;
import com.channelengine.channel.apiclient.auth.HttpBearerAuth;
import com.channelengine.channel.apiclient.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://dev.channelengine.local/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.9.10/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://dev.channelengine.local/api
