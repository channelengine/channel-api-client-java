...
public class ProductApi {
     ...
     */
    public SingleOfChannelProductChangesResponse productGetDataChanges(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<SingleOfChannelProductChangesResponse> localVarResp = productGetDataChangesWithHttpInfo(maxCount, stripHtml, page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SingleOfChannelProductChangesResponse> productGetDataChangesWithHttpInfo(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
     ...
     */
    public okhttp3.Call productGetDataChangesAsync(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback<SingleOfChannelProductChangesResponse> _callback) throws ApiException {
