...
import com.channelengine.channel.apiclient.model.CollectionChangesOfChannelProductChangesResponse;
...
public class ProductApi {
     ...
     */
    public okhttp3.Call productGetDataChangesCall(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call productGetDataChangesValidateBeforeCall(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = productGetDataChangesCall(maxCount, stripHtml, page, pageSize, _callback);
        return localVarCall;
     ...
     */
    public CollectionChangesOfChannelProductChangesResponse productGetDataChanges(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<CollectionChangesOfChannelProductChangesResponse> localVarResp = productGetDataChangesWithHttpInfo(maxCount, stripHtml, page, pageSize);
        return localVarResp.getData();
    }
     ...
     * @param page  (optional)
     * @param pageSize  (optional)
     * @return ApiResponse&lt;CollectionChangesOfChannelProductChangesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CollectionChangesOfChannelProductChangesResponse> productGetDataChangesWithHttpInfo(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = productGetDataChangesValidateBeforeCall(maxCount, stripHtml, page, pageSize, null);
        Type localVarReturnType = new TypeToken<CollectionChangesOfChannelProductChangesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call productGetDataChangesAsync(Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback<CollectionChangesOfChannelProductChangesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = productGetDataChangesValidateBeforeCall(maxCount, stripHtml, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<CollectionChangesOfChannelProductChangesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call productGetDataChangesFullCall(DataChangesProductType productType, Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call productGetDataChangesFullValidateBeforeCall(DataChangesProductType productType, Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = productGetDataChangesFullCall(productType, maxCount, stripHtml, page, pageSize, _callback);
        return localVarCall;
     ...
     */
    public CollectionChangesOfChannelProductChangesResponse productGetDataChangesFull(DataChangesProductType productType, Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<CollectionChangesOfChannelProductChangesResponse> localVarResp = productGetDataChangesFullWithHttpInfo(productType, maxCount, stripHtml, page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionChangesOfChannelProductChangesResponse> productGetDataChangesFullWithHttpInfo(DataChangesProductType productType, Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = productGetDataChangesFullValidateBeforeCall(productType, maxCount, stripHtml, page, pageSize, null);
        Type localVarReturnType = new TypeToken<CollectionChangesOfChannelProductChangesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call productGetDataChangesFullAsync(DataChangesProductType productType, Integer maxCount, Boolean stripHtml, Integer page, Integer pageSize, final ApiCallback<CollectionChangesOfChannelProductChangesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = productGetDataChangesFullValidateBeforeCall(productType, maxCount, stripHtml, page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<CollectionChangesOfChannelProductChangesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call productGetOfferChangesCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call productGetOfferChangesValidateBeforeCall(Integer page, Integer pageSize, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = productGetOfferChangesCall(page, pageSize, _callback);
        return localVarCall;
     ...
     */
    public CollectionOfChannelOfferResponse productGetOfferChanges(Integer page, Integer pageSize) throws ApiException {
        ApiResponse<CollectionOfChannelOfferResponse> localVarResp = productGetOfferChangesWithHttpInfo(page, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionOfChannelOfferResponse> productGetOfferChangesWithHttpInfo(Integer page, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = productGetOfferChangesValidateBeforeCall(page, pageSize, null);
     ...
     */
    public okhttp3.Call productGetOfferChangesAsync(Integer page, Integer pageSize, final ApiCallback<CollectionOfChannelOfferResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = productGetOfferChangesValidateBeforeCall(page, pageSize, _callback);
        Type localVarReturnType = new TypeToken<CollectionOfChannelOfferResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
