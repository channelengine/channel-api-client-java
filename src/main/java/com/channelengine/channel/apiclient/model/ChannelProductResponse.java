...
import com.channelengine.channel.apiclient.model.ProductType;
import com.channelengine.channel.apiclient.model.VatRateType;
...
public class ChannelProductResponse {
  ...
  public static final String SERIALIZED_NAME_PARENT_CHANNEL_PRODUCT_NO = "ParentChannelProductNo";
  @SerializedName(SERIALIZED_NAME_PARENT_CHANNEL_PRODUCT_NO)
  private String parentChannelProductNo;

  public static final String SERIALIZED_NAME_GRANDPARENT_CHANNEL_PRODUCT_NO = "GrandparentChannelProductNo";
  @SerializedName(SERIALIZED_NAME_GRANDPARENT_CHANNEL_PRODUCT_NO)
  private String grandparentChannelProductNo;
  ...
  **/
  ...
  public ChannelProductResponse channelProductNo(String channelProductNo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique product reference used by the Channel for the product.")
  ...
  **/
  ...
  public ChannelProductResponse grandparentChannelProductNo(String grandparentChannelProductNo) {
   ...
   * @return grandparentChannelProductNo
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique product reference used by the Channel for the grandparent product.")

  public String getGrandparentChannelProductNo() {
    return grandparentChannelProductNo;
  }


  public void setGrandparentChannelProductNo(String grandparentChannelProductNo) {
    this.grandparentChannelProductNo = grandparentChannelProductNo;
  }
  ...
  **/
  ...
  public ChannelProductResponse productType(ProductType productType) {
  ...
  **/
  ...
  public ChannelProductResponse merchantProductNo(String merchantProductNo) {
  ...
  **/
  ...
  public ChannelProductResponse vatRateType(VatRateType vatRateType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, channelProductResponse.id) &&
        Objects.equals(this.channelProductNo, channelProductResponse.channelProductNo) &&
        Objects.equals(this.parentChannelProductNo, channelProductResponse.parentChannelProductNo) &&
        Objects.equals(this.grandparentChannelProductNo, channelProductResponse.grandparentChannelProductNo) &&
        ...
        Objects.equals(this.merchantProductNo, channelProductResponse.merchantProductNo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, channelProductNo, parentChannelProductNo, grandparentChannelProductNo, mappedFields, productType, extraData, name, description, brand, size, color, ean, manufacturerProductNumber, merchantProductNo, stock, price, MSRP, purchasePrice, vatRateType, shippingCost, shippingTime, url, imageUrl, extraImageUrl1, extraImageUrl2, extraImageUrl3, extraImageUrl4, extraImageUrl5, extraImageUrl6, extraImageUrl7, extraImageUrl8, extraImageUrl9, categoryTrail);
  }
  ...
  public String toString() {
    ...
    sb.append("    grandparentChannelProductNo: ").append(toIndentedString(grandparentChannelProductNo)).append("\n");
