...
public class ChannelProductResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentChannelProductNo, grandparentChannelProductNo, mappedFields, extraData, name, description, brand, size, color, ean, manufacturerProductNumber, stock, price, MSRP, purchasePrice, vatRateType, shippingCost, shippingTime, url, imageUrl, extraImageUrl1, extraImageUrl2, extraImageUrl3, extraImageUrl4, extraImageUrl5, extraImageUrl6, extraImageUrl7, extraImageUrl8, extraImageUrl9, categoryTrail);
  }
