...
public class ChannelReturnRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(channelOrderNo, merchantOrderNo, channelReference, keyIsMerchantOrderNo, keyIsMerchantProductNo, lines, status, id, reason, customerComment, merchantComment, refundInclVat, refundExclVat, returnDate);
  }
