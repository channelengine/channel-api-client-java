...
public class ChannelReturnRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(channelOrderNo, merchantOrderNo, channelReference, keyIsMerchantOrderNo, keyIsMerchantProductNo, lines, id, reason, customerComment, merchantComment, refundInclVat, refundExclVat, returnDate);
  }
